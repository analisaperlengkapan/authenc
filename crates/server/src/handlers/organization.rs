...
pub async fn add_member(
    ...
    let role = match request.role.as_str() {
        "owner" => authenc_services::services::organization::OrganizationRole::Owner,
        "admin" => authenc_services::services::organization::OrganizationRole::Admin,
        "member" => authenc_services::services::organization::OrganizationRole::Member,
        "guest" => authenc_services::services::organization::OrganizationRole::Guest,
...
pub async fn update_settings(
    State(db): State<Database>,
    Path(id): Path<Uuid>,
    Json(settings): Json<authenc_services::services::organization::OrganizationSettings>,
) -> Result<Json<serde_json::Value>> {
    let service = OrganizationService::new(Arc::new(db));
