...
use authenc_api::models::events::{Event, EventType};
...
pub async fn process_consent(
    ...
    match decision.decision.as_str() {
        "allow" => {
            ...
            // Grant consent
            let consent_request = authenc_api::models::ConsentGrantRequest {
...
fn generate_consent_html(
    client: &authenc_api::models::oidc_client::OidcClient,
    scopes: &[String],
    params: &ConsentQuery,
    user: &AuthUser,
) -> String {
