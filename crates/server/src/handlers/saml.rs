...
use authenc_db::database::operations::identity_providers::get_identity_provider_by_entity_id;
use authenc_api::error::AuthencError;
use crate::handlers::federated_auth::MockAdminService;
use authenc_api::models::user::JITUserProvisioningRequest;
...
impl AdminService for SamlAdminService {
    async fn get_system_stats(&self) -> Result<authenc_services::services::admin::SystemStats, String> {
    ...
    ) -> Result<authenc_services::services::admin::UserResponse, String> {
        // Use the database operations to create user
        use authenc_db::database::operations::{groups, roles, users};
        use authenc_api::models::user::CreateUserRequest as DbCreateUserRequest;
    ...
    async fn update_user(
        &self,
        _user_id: &uuid::Uuid,
        _request: authenc_services::services::admin::UpdateUserRequest,
    ) -> Result<authenc_services::services::admin::UserResponse, String> {
        Err("Not implemented".to_string())
    }
    ...
    async fn create_role(
        &self,
        _request: authenc_services::services::admin::CreateRoleRequest,
    ...
    async fn get_sessions(
        ...
        _page: u32,
        _limit: u32,
    ) -> Result<authenc_services::services::admin::SessionListResponse, String> {
        Err("Not implemented".to_string())
    }
    ...
    ) -> Result<authenc_services::services::admin::AuditLogResponse, String> {
        Err("Not implemented".to_string())
    }
    ...
    async fn get_policies(
        ...
        _page: u32,
        _limit: u32,
    ) -> Result<Vec<authenc_services::services::admin::PolicyResponse>, String> {
        Err("Not implemented".to_string())
    }
    ...
    ) -> Result<authenc_services::services::admin::PolicyResponse, String> {
        Err("Not implemented".to_string())
    }
    ...
    async fn get_zero_trust_dashboard(
        &self,
        _realm_id: &uuid::Uuid,
    ) -> Result<authenc_services::services::admin::ZeroTrustDashboard, String> {
        Err("Not implemented".to_string())
    }
    ...
    async fn get_identity_providers(
        &self,
        _realm_id: &uuid::Uuid,
    ) -> Result<Vec<authenc_services::services::admin::IdentityProviderResponse>, String> {
        Err("Not implemented".to_string())
    }
    ...
    ) -> Result<authenc_services::services::admin::IdentityProviderResponse, String> {
        Err("Not implemented".to_string())
    }
    ...
    async fn test_identity_provider(
        &self,
        _provider_id: &uuid::Uuid,
    ) -> Result<authenc_services::services::admin::TestIdentityProviderResponse, String> {
        Err("Not implemented".to_string())
    }
}
