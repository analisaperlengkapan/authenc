...
use std::sync::Arc;
use authenc_api::models::social_account::CreateSocialAccountRequest;
use authenc_api::models::user::CreateUserRequest;
...
pub async fn social_callback(
    ...
    let user_id = if let Some(account) = existing_account {
        ...
        if let Some(user) = existing_user {
             ...
             if profile.verified_email {
                 let update_req = authenc_api::models::user::UpdateUserRequest {
                     username: None,
                     email: None,
                     first_name: None,
                     last_name: None,
