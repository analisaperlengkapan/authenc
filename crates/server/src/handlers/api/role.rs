...
use authenc_api::models::events::{OperationType, ResourceType};
...
pub async fn assign_permission_to_role(
    ...
    authenc_db::database::operations::roles::assign_permission_to_role(
        &state.database,
        &role.id,
        &permission_obj.id,
    )
...
pub async fn unassign_permission_from_role(
    ...
    authenc_db::database::operations::roles::remove_permission_from_role(
        &state.database,
        &role.id,
        &permission_obj.id,
    )
