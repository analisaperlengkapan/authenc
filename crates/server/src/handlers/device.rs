...
pub async fn register_device(
    ...
    let device_request = DeviceRegistrationRequest {
        ...
        security_features: authenc_services::services::device::DeviceSecurityFeatures {
...
pub async fn update_device(
...
) -> authenc_api::error::Result<impl axum::response::IntoResponse> {
    let service = DeviceService::new(state.database.clone());
    ...
    let updates = authenc_services::services::device::DeviceUpdateRequest {
