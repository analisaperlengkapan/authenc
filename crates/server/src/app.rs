...
pub struct AppState {
    ...
    pub database: Arc<authenc_db::database::Database>,
    /// User data store
...
impl AppState {
    ...
    pub async fn new(config: AppConfig) -> Result<Self> {
        ...
        let database = Arc::new(
            authenc_db::database::Database::new(&config.database)
                .await
                .map_err(|e| {
...
impl FromRef<Arc<AppState>> for authenc_db::database::Database {
    fn from_ref(state: &Arc<AppState>) -> Self {
