...
fn validate_token(token: &str, _secret: &str) -> Result<AuthUser, AuthencError> {
    ...
    let claims = authenc_core::utils::crypto::jwt::verify_jwt(token).map_err(|e| {
...
mod tests {
    ...
    fn create_test_token(claims: &authenc_core::utils::crypto::jwt::Claims) -> String {
        use authenc_crypto::ed25519_keys::sign_ed25519;
    ...
    async fn test_auth_middleware_comprehensive() {
        ...
        // 3. Test valid token
        use authenc_core::utils::crypto::jwt::generate_jwt;
    ...
    async fn test_expired_token() {
        use authenc_core::utils::crypto::jwt::Claims;
