...
mod tests {
    ...
    impl crate::services::events::EventStoreProvider for MockEventStore {
        async fn store_event(
            &self,
            _event: &authenc_models::models::events::Event,
        ) -> authenc_core::error::Result<()> {
            Ok(())
        }

        async fn store_admin_event(
            &self,
            _event: &authenc_models::models::events::AdminEvent,
        ) -> authenc_core::error::Result<()> {
            Ok(())
        }
        ...
        async fn query_events(
            ...
            _first_result: usize,
            _max_results: usize,
        ) -> authenc_core::error::Result<Vec<authenc_models::models::events::Event>> {
            Ok(Vec::new())
        }
        ...
        async fn query_admin_events(
            ...
            _first_result: usize,
            _max_results: usize,
        ) -> authenc_core::error::Result<Vec<authenc_models::models::events::AdminEvent>> {
            Ok(Vec::new())
        }
        ...
        ) -> authenc_core::error::Result<usize> {
            Ok(0)
        }
    }
}
