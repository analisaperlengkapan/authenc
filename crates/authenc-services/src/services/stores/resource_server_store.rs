...
use authenc_models::models::resource_server::{
...
impl ResourceServerStoreTrait for ResourceServerStore {
    async fn create_resource_server(
        ...
        authenc_database::database::operations::resource_servers::create_resource_server(
            &self.database,
            request,
            realm_id,
        )
    ...
    async fn get_resource_server(&self, id: Uuid) -> Result<Option<ResourceServer>, AuthencError> {
        authenc_database::database::operations::resource_servers::get_resource_server_by_id(&self.database, id)
            .await
    }
    ...
    async fn get_resource_server_by_client(
        ...
        authenc_database::database::operations::resource_servers::get_resource_server_by_client(
            &self.database,
            client_id,
            realm_id,
        )
    ...
    async fn get_resource_servers_by_realm(
        ...
        authenc_database::database::operations::resource_servers::get_resource_servers_by_realm(
            &self.database,
            realm_id,
            first,
            max,
    ...
    async fn update_resource_server(
        ...
        authenc_database::database::operations::resource_servers::update_resource_server(
            &self.database,
            id,
            request,
        )
    ...
    async fn delete_resource_server(&self, id: Uuid) -> Result<(), AuthencError> {
        authenc_database::database::operations::resource_servers::delete_resource_server(&self.database, id)
            .await
    }
    ...
    async fn search_resource_servers(
        ...
        authenc_database::database::operations::resource_servers::search_resource_servers(
            &self.database,
            name,
            realm_id,
            first,
    ...
    async fn count_resource_servers_by_realm(&self, realm_id: Uuid) -> Result<i64, AuthencError> {
        authenc_database::database::operations::resource_servers::count_resource_servers_by_realm(
            &self.database,
            realm_id,
        )
        .await
