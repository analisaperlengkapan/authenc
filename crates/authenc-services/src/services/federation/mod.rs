...
pub mod jit_provisioning {
    ...
    use authenc_database::database::Database;
    use authenc_models::models::user::{CreateFederatedIdentityRequest, FederatedIdentity, JITUserProvisioningRequest, JITUserProvisioningResponse, User};
    ...
    impl JITProvisioningService for DefaultJITProvisioningService {
        async fn provision_user(
            ...
            use authenc_database::database::operations::{federated_identities, users};
                ...
                .await?
            {
                ...
                let user = users::get_user_by_id(&self.db, existing_federated.user_id)
                    .await?
                    .ok_or(authenc_core::error::AuthencError::AuthenticationFailed)?;
        ...
        async fn link_user(
            ...
            use authenc_database::database::operations::federated_identities;
