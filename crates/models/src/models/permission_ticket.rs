    ...
    fn try_from(row: tokio_postgres::Row) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            resource_id: row.try_get("resource_id").map_err(|e| {
                authenc_core::error::AuthencError::database(format!("Failed to get resource_id: {}", e))
            })?,
            scope_id: row.try_get("scope_id").map_err(|e| {
                authenc_core::error::AuthencError::database(format!("Failed to get scope_id: {}", e))
            })?,
            ...
            requester: row.try_get("requester").map_err(|e| {
                authenc_core::error::AuthencError::database(format!("Failed to get requester: {}", e))
            })?,
            granted: row.try_get("granted").map_err(|e| {
                authenc_core::error::AuthencError::database(format!("Failed to get granted: {}", e))
            })?,
