...
impl ResourceStoreTrait for ResourceStore {
    async fn create_resource(
        ...
        authenc_db::database::operations::resources::create_resource(
            &self.database,
            request,
            owner,
            realm_id,
    ...
    async fn get_resource(&self, id: Uuid) -> Result<Option<Resource>, AuthencError> {
        authenc_db::database::operations::resources::get_resource_by_id(&self.database, id).await
    }
    ...
    async fn get_resource_by_name(
        ...
        authenc_db::database::operations::resources::get_resource_by_name(
            &self.database,
            name,
            resource_server_id,
        )
    ...
    async fn get_resources_by_owner(
        ...
        authenc_db::database::operations::resources::get_resources_by_owner(
            &self.database,
            owner,
            first,
            max,
    ...
    async fn get_resources_by_server(
        ...
        authenc_db::database::operations::resources::get_resources_by_server(
            &self.database,
            resource_server_id,
            first,
            max,
    ...
    async fn get_resources_by_realm(
        ...
        authenc_db::database::operations::resources::get_resources_by_realm(
            &self.database,
            realm_id,
            first,
            max,
    ...
    async fn update_resource(
        ...
        authenc_db::database::operations::resources::update_resource(&self.database, id, request).await
    }

    async fn delete_resource(&self, id: Uuid) -> Result<(), AuthencError> {
        authenc_db::database::operations::resources::delete_resource(&self.database, id).await
    }
    ...
    async fn search_resources(
        ...
        authenc_db::database::operations::resources::search_resources(
            &self.database,
            name,
            realm_id,
            first,
    ...
    async fn count_resources_by_owner(&self, owner: &str) -> Result<i64, AuthencError> {
        authenc_db::database::operations::resources::count_resources_by_owner(&self.database, owner)
            .await
    }
}
