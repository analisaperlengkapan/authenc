...
impl ConsentStoreTrait for ConsentStore {
    async fn grant_consent(
        ...
        authenc_db::database::operations::user_consents::grant_consent(&self.database, user_id, &request)
            .await
    }

    async fn revoke_consent(&self, user_id: Uuid, client_id: &str) -> Result<(), AuthencError> {
        authenc_db::database::operations::user_consents::revoke_consent(
            &self.database,
            user_id,
            client_id,
        )
    ...
    async fn get_user_consents(&self, user_id: Uuid) -> Result<Vec<UserConsent>, AuthencError> {
        authenc_db::database::operations::user_consents::get_user_consents(&self.database, user_id).await
    }
    ...
    async fn get_user_consent(
        ...
        authenc_db::database::operations::user_consents::get_user_consent(
            &self.database,
            user_id,
            client_id,
        )
    ...
    async fn has_consent(
        ...
        authenc_db::database::operations::user_consents::has_consent(
            &self.database,
            user_id,
            client_id,
            scopes,
    ...
    async fn cleanup_expired_consents(&self) -> Result<i64, AuthencError> {
        authenc_db::database::operations::user_consents::cleanup_expired_consents(&self.database).await
    }
    ...
    async fn revoke_consent_by_id(
        ...
        authenc_db::database::operations::user_consents::revoke_consent_by_id(
            &self.database,
            user_id,
            consent_id,
        )
    ...
    async fn get_consent_stats(&self, user_id: Uuid) -> Result<serde_json::Value, AuthencError> {
        authenc_db::database::operations::user_consents::get_consent_stats(&self.database, user_id).await
    }
}
