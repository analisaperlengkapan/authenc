...
impl DeviceService {
    ...
    pub async fn update_device(&self, device_id: Uuid, updates: DeviceUpdateRequest) -> Result<()> {
        use authenc_database::database::operations::devices;
    ...
    pub async fn register_device_db(
        &self,
        device: &DeviceInfo,
    ) -> Result<authenc_models::models::device::Device> {
        use authenc_database::database::operations::devices;
        use authenc_models::models::device::DeviceInfo as ModelDeviceInfo;
    ...
    async fn store_session(&self, session: &DeviceSession) -> Result<()> {
        use authenc_database::database::operations as db_ops;
...
impl From<&DeviceInfo> for authenc_models::models::device::DeviceInfo {
    fn from(device: &DeviceInfo) -> Self {
        authenc_models::models::device::DeviceInfo {
...
impl From<authenc_models::models::device::Device> for DeviceInfo {
    fn from(model_device: authenc_models::models::device::Device) -> Self {
        // Parse security features from JSON
        let security_features = model_device
            .security_features
            .clone()
