...
impl DeviceService {
    ...
    pub async fn update_device(&self, device_id: Uuid, updates: DeviceUpdateRequest) -> Result<()> {
        use authenc_db::database::operations::devices;
    ...
    pub async fn update_session_activity(&self, session_id: Uuid) -> Result<()> {
        use authenc_db::database::operations::sessions;
    ...
    pub async fn register_device_db(
        &self,
        device: &DeviceInfo,
    ) -> Result<authenc_api::models::device::Device> {
        use authenc_db::database::operations::devices;
        use authenc_api::models::device::DeviceInfo as ModelDeviceInfo;
...
impl From<&DeviceInfo> for authenc_api::models::device::DeviceInfo {
    fn from(device: &DeviceInfo) -> Self {
        authenc_api::models::device::DeviceInfo {
...
impl From<authenc_api::models::device::Device> for DeviceInfo {
    fn from(model_device: authenc_api::models::device::Device) -> Self {
        // Parse security features from JSON
        let security_features = model_device
            .security_features
            .clone()
