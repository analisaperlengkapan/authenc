...
impl KafkaEventListener {
    ...
    pub fn new(brokers: &str, user_events_topic: &str, admin_events_topic: &str) -> Result<Self> {
        let producer: FutureProducer = ClientConfig::new()
            ...
            .create()
            .map_err(|e| authenc_core::error::AuthencError::InternalError {
    ...
    async fn send_to_kafka(
        ...
        let payload = serde_json::to_string(event).map_err(|e| {
            authenc_core::error::AuthencError::InternalError {
        ...
        match self.producer.send(record, Duration::from_secs(5)).await {
            ...
            Err((e, _)) => {
                ...
                Err(authenc_core::error::AuthencError::InternalError {
...
mod tests {
    use super::*;
    use authenc_models::models::events::{AuthDetails, EventType, OperationType, ResourceType};
