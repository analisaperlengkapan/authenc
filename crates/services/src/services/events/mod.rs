...
impl EventBuilder {
    ...
    pub fn new(event_type: authenc_api::models::events::EventType, realm_id: String) -> Self {
        Self {
...
impl AdminEventBuilder {
    ...
    pub fn new(
        realm_id: String,
        auth_details: authenc_api::models::events::AuthDetails,
        resource_type: authenc_api::models::events::ResourceType,
        operation_type: authenc_api::models::events::OperationType,
