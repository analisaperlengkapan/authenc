...
impl EventBuilder {
    ...
    pub fn new(event_type: authenc_models::models::events::EventType, realm_id: String) -> Self {
        Self {
...
impl AdminEventBuilder {
    ...
    pub fn new(
        ...
        resource_type: authenc_models::models::events::ResourceType,
        operation_type: authenc_models::models::events::OperationType,
