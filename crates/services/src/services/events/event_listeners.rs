...
use authenc_api::models::events::{AdminEvent, Event};
...
impl EventListenerProvider for LoggingEventListener {
    async fn on_event(&self, event: &Event) -> Result<()> {
        match event.event_type {
            authenc_api::models::events::EventType::Login => {
                tracing::info!(
            ...
            authenc_api::models::events::EventType::LoginError => {
                tracing::warn!(
            ...
            authenc_api::models::events::EventType::Register => {
                tracing::info!(
            ...
            authenc_api::models::events::EventType::Logout => {
                tracing::info!(
            ...
            authenc_api::models::events::EventType::UpdateProfile => {
                tracing::info!(
                    "User profile updated: user_id={}",
                    event.user_id.as_deref().unwrap_or("unknown")
                );
            }
            authenc_api::models::events::EventType::ResetPassword => {
                tracing::info!(
...
impl EventListenerProvider for EmailEventListener {
    async fn on_event(&self, event: &Event) -> Result<()> {
        ...
        match event.event_type {
            authenc_api::models::events::EventType::UserDisabledByPermanentLockout => {
            ...
            authenc_api::models::events::EventType::UserDisabledByTemporaryLockout => {
    ...
    async fn on_admin_event(
        ...
        match (&event.operation_type, &event.resource_type) {
            ...
            (
                ...
                authenc_api::models::events::ResourceType::Realm,
            ) => {
                tracing::info!(
