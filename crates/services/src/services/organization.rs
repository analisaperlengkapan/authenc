...
impl OrganizationService {
    ...
    pub async fn get_organization(&self, organization_id: &Uuid) -> Result<Option<Organization>> {
        authenc_db::database::operations::organizations::get_organization_by_id(
            &self.db,
            *organization_id,
        )
        .await
    ...
    pub async fn get_organization_by_domain(&self, domain: &str) -> Result<Option<Organization>> {
        authenc_db::database::operations::organizations::get_organization_by_domain(&self.db, domain)
            .await
            .map_err(|e| {
    ...
    pub async fn delete_organization(&self, organization_id: &Uuid) -> Result<()> {
        authenc_db::database::operations::organizations::delete_organization(&self.db, organization_id)
            .await
    ...
    pub async fn remove_member(&self, organization_id: &Uuid, user_id: &Uuid) -> Result<()> {
        authenc_db::database::operations::organizations::remove_organization_member(
            &self.db,
            organization_id,
            user_id,
        )
    ...
    pub async fn get_members(&self, organization_id: &Uuid) -> Result<Vec<OrganizationMember>> {
        authenc_db::database::operations::organizations::get_organization_members(
            &self.db,
            organization_id,
        )
        .await
    ...
    pub async fn get_user_organizations(&self, user_id: &Uuid) -> Result<Vec<Organization>> {
        authenc_db::database::operations::organizations::get_user_organizations(&self.db, user_id)
            .await
    ...
    ) -> Result<authenc_db::database::operations::organizations::OrganizationDomain> {
        authenc_db::database::operations::organizations::add_domain(
            &self.db,
            *organization_id,
            domain,
            verification_method,
    ...
    pub async fn verify_domain(&self, domain_id: &Uuid) -> Result<()> {
        authenc_db::database::operations::organizations::verify_domain(&self.db, *domain_id).await
    }
    ...
    pub async fn get_domains(
        &self,
        organization_id: &Uuid,
    ) -> Result<Vec<authenc_db::database::operations::organizations::OrganizationDomain>> {
        authenc_db::database::operations::organizations::get_domains(&self.db, *organization_id).await
    }
    ...
    pub async fn link_identity_provider(
        ...
        authenc_db::database::operations::organizations::link_identity_provider(
            &self.db,
            *organization_id,
    ...
    pub async fn unlink_identity_provider(
        ...
        authenc_db::database::operations::organizations::unlink_identity_provider(
            &self.db,
            *organization_id,
            *identity_provider_id,
        )
    ...
    async fn store_organization(&self, organization: &Organization) -> Result<()> {
        authenc_db::database::operations::organizations::create_organization(&self.db, organization)
            .await
    ...
    async fn store_member(&self, member: &OrganizationMember) -> Result<()> {
        authenc_db::database::operations::organizations::add_member(
            &self.db,
    ...
    async fn store_invitation(&self, invitation: &OrganizationInvitation) -> Result<()> {
        ...
        authenc_db::database::operations::organizations::create_invitation(&self.db, &model_invitation)
            .await
    }
    ...
    async fn get_invitation_by_token(&self, token: &str) -> Result<Option<OrganizationInvitation>> {
        ...
        let model_invitation = authenc_db::database::operations::organizations::get_invitation_by_token(
            &self.db,
            &token_hash,
        )
        .await?;
