...
pub mod jit_provisioning {
    ...
    impl JITProvisioningService for DefaultJITProvisioningService {
        async fn provision_user(
            ...
            use authenc_db::database::operations::{federated_identities, users};
                ...
                .await?
            {
                ...
                let user = users::get_user_by_id(&self.db, existing_federated.user_id)
                    .await?
                    .ok_or(authenc_api::error::AuthencError::AuthenticationFailed)?;
        ...
        async fn link_user(
            ...
            use authenc_db::database::operations::federated_identities;
    ...
    impl DefaultJITProvisioningService {
        ...
        async fn create_federated_user(
            ...
            let user_response = self.admin_service.create_user(create_request).await
                .map_err(authenc_api::error::AuthencError::database)?;
