...
use authenc_db::database::operations::users;
use authenc_db::database::Database;
use authenc_api::error::{AuthencError, Result};
use authenc_api::models::webauthn::{WebauthnCredential, WebauthnAuthenticationResponse, WebauthnRegistrationResponse};
...
impl WebAuthnService {
    ...
    async fn store_credential(
        ...
        let model_credential = authenc_api::models::webauthn::WebauthnCredential {
            id: credential.id,
            user_id: user.id,
    ...
    async fn get_user_credentials(&self, realm_id: &Uuid, username: &str) -> Result<Vec<WebauthnCredential>> {
        use authenc_db::database::operations::users;
        use authenc_db::database::operations::webauthn as webauthn_db;
