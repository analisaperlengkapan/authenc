...
#[async_trait]
pub trait UserStorageRepository: StorageRepository<authenc_api::models::user::User> {
    /// Find user by username
    async fn find_by_username(&self, username: &str) -> Result<Option<authenc_api::models::user::User>, AuthencError>;

    /// Find user by email
    async fn find_by_email(&self, email: &str) -> Result<Option<authenc_api::models::user::User>, AuthencError>;

    /// Find users by role
    async fn find_by_role(&self, role_id: &str) -> Result<Vec<authenc_api::models::user::User>, AuthencError>;
}

/// Client Storage Repository
#[async_trait]
pub trait ClientStorageRepository: StorageRepository<authenc_api::models::oauth2::OAuth2Client> {
    /// Find client by client ID
    async fn find_by_client_id(&self, client_id: &str) -> Result<Option<authenc_api::models::oauth2::OAuth2Client>, AuthencError>;

    /// Find clients by owner
    async fn find_by_owner(&self, owner_id: &str) -> Result<Vec<authenc_api::models::oauth2::OAuth2Client>, AuthencError>;
}

/// Realm Storage Repository
#[async_trait]
pub trait RealmStorageRepository: StorageRepository<authenc_api::models::realm::Realm> {
    /// Find realm by name
    async fn find_by_name(&self, name: &str) -> Result<Option<authenc_api::models::realm::Realm>, AuthencError>;

    /// Find realms by owner
    async fn find_by_owner(&self, owner_id: &str) -> Result<Vec<authenc_api::models::realm::Realm>, AuthencError>;
}
...
#[async_trait]
impl StorageRepository<authenc_api::models::user::User> for InMemoryUserRepository {
    async fn find_by_id(&self, id: &str) -> Result<Option<authenc_api::models::user::User>, AuthencError> {
        let storage = self.storage.read().await;
        if let Some(user_store) = storage.get("users") {
            if let Some(value) = user_store.get(id) {
                let user: authenc_api::models::user::User = serde_json::from_value(value.clone())
                    .map_err(|_| AuthencError::SerializationError {
    ...
    async fn find_all(&self) -> Result<Vec<authenc_api::models::user::User>, AuthencError> {
        let storage = self.storage.read().await;
    ...
    async fn save(&self, user: &authenc_api::models::user::User) -> Result<(), AuthencError> {
        let mut storage = self.storage.write().await;
    ...
    async fn update(&self, user: &authenc_api::models::user::User) -> Result<(), AuthencError> {
...
impl UserStorageRepository for InMemoryUserRepository {
    ...
    async fn find_by_role(&self, _role_id: &str) -> Result<Vec<authenc_api::models::user::User>, AuthencError> {
...
#[async_trait]
impl StorageRepository<authenc_api::models::oauth2::OAuth2Client> for InMemoryClientRepository {
    async fn find_by_id(&self, id: &str) -> Result<Option<authenc_api::models::oauth2::OAuth2Client>, AuthencError> {
        let storage = self.storage.read().await;
        if let Some(client_store) = storage.get("clients") {
            if let Some(value) = client_store.get(id) {
                let client: authenc_api::models::oauth2::OAuth2Client = serde_json::from_value(value.clone())
                    .map_err(|_| AuthencError::SerializationError {
    ...
    async fn find_all(&self) -> Result<Vec<authenc_api::models::oauth2::OAuth2Client>, AuthencError> {
        let storage = self.storage.read().await;
    ...
    async fn save(&self, client: &authenc_api::models::oauth2::OAuth2Client) -> Result<(), AuthencError> {
        let mut storage = self.storage.write().await;
    ...
    async fn update(&self, client: &authenc_api::models::oauth2::OAuth2Client) -> Result<(), AuthencError> {
...
impl ClientStorageRepository for InMemoryClientRepository {
    ...
    async fn find_by_owner(&self, _owner_id: &str) -> Result<Vec<authenc_api::models::oauth2::OAuth2Client>, AuthencError> {
        // Placeholder implementation
        Ok(vec![])
    }
}
...
#[async_trait]
impl StorageRepository<authenc_api::models::realm::Realm> for InMemoryRealmRepository {
    async fn find_by_id(&self, id: &str) -> Result<Option<authenc_api::models::realm::Realm>, AuthencError> {
        let storage = self.storage.read().await;
        if let Some(realm_store) = storage.get("realms") {
            if let Some(value) = realm_store.get(id) {
                let realm: authenc_api::models::realm::Realm = serde_json::from_value(value.clone())
                    .map_err(|_| AuthencError::SerializationError {
    ...
    async fn find_all(&self) -> Result<Vec<authenc_api::models::realm::Realm>, AuthencError> {
        let storage = self.storage.read().await;
    ...
    async fn save(&self, realm: &authenc_api::models::realm::Realm) -> Result<(), AuthencError> {
        let mut storage = self.storage.write().await;
    ...
    async fn update(&self, realm: &authenc_api::models::realm::Realm) -> Result<(), AuthencError> {
...
impl RealmStorageRepository for InMemoryRealmRepository {
    ...
    async fn find_by_owner(&self, _owner_id: &str) -> Result<Vec<authenc_api::models::realm::Realm>, AuthencError> {
        // Placeholder implementation
        Ok(vec![])
    }
}
...
mod tests {
    ...
    use authenc_api::models::oauth2::OAuth2Client;
