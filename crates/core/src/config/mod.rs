...
pub type Result<T> = authenc_api::error::Result<T>;
...
pub struct ClusterConfig {
    ...
    #[serde(default)]
    pub communication_type: authenc_api::clustering::ClusterCommunicationType,
    /// Type of cluster membership management
    #[serde(default)]
    pub membership_type: authenc_api::clustering::ClusterMembershipType,
    /// Type of distributed consensus algorithm
    #[serde(default)]
    pub consensus_type: authenc_api::clustering::ClusterConsensusType,
...
impl Default for ClusterConfig {
    fn default() -> Self {
        Self {
            ...
            node_id: None,
            communication_type: authenc_api::clustering::ClusterCommunicationType::Infinispan,
            membership_type: authenc_api::clustering::ClusterMembershipType::Kubernetes,
            consensus_type: authenc_api::clustering::ClusterConsensusType::Raft,
