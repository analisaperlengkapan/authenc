...
use authenc_api::models::oidc_client::OidcClient;
use authenc_api::models::role::Role;
use authenc_api::models::user::User;
use crate::traits::store::{
    UserStoreTrait, OidcClientStoreTrait, RoleStoreTrait, GroupStoreTrait
};
...
impl UserStorageProvider for DefaultUserStorageProvider {
    ...
    async fn create_user(&self, user: User) -> Result<User> {
        ...
        let request = authenc_api::models::user::CreateUserRequest {
    ...
    async fn update_user(&self, user: User) -> Result<User> {
        ...
        let request = authenc_api::models::user::UpdateUserRequest {
