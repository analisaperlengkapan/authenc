...
pub mod groups { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::{AuthencError, Result};

    use authenc_api::models::Group;
    use chrono::Utc;
...
pub mod devices { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::{AuthencError, Result};

    use authenc_api::models::{Device, DeviceInfo};
    use chrono::Utc;
    use tracing::error;
    use uuid::Uuid;
...
pub mod oauth2 { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::{OAuth2AccessToken, OAuth2AuthorizationCode, OAuth2Client};
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod organizations { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::{AuthencError, Result};

    use authenc_api::models::{Organization, OrganizationInvitation, OrganizationMember};

    use authenc_api::models::OrganizationRole;
    use chrono::Utc;
    use tracing::error;
...
pub mod saml { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::{SamlServiceProvider, SamlSession};
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod audit { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use authenc_api::models::AuditEvent;
...
pub mod users { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::{User, user::CreateUserRequest, user::UpdateUserRequest};
    ...
    pub async fn create_user(db: &Database, request: &CreateUserRequest) -> Result<User> {
        ...
        let password_hash = if let Some(p) = &request.password {
            Some(authenc_core::utils::crypto::password::hash_password(p).await.unwrap_or_default())
        } else {
            None
        };
...
pub mod social_accounts { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::social_account::{CreateSocialAccountRequest, SocialAccount};

    use authenc_api::social::SocialProvider;
    use chrono::Utc;
    use std::str::FromStr;
    use uuid::Uuid;
...
pub mod oauth2_providers { use crate::database::RowExt;
    use super::*;
...
pub mod realms { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::{Realm, realm::CreateRealmRequest, realm::UpdateRealmRequest};
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod federated_identity { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
...
pub mod admin_console { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::{DateTime, Duration, Utc};
    use serde_json::Value as JsonValue;
...
pub mod events { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::{DateTime, Utc};
    use serde_json::Value as JsonValue;
    ...
    pub async fn query_event_log(
        ...
        let rows: Vec<tokio_postgres::Row> = db.query_raw(&query, &params_refs).await?;
...
pub mod protocol_mappers { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::Utc;
    use serde_json::Value as JsonValue;
...
pub mod authenticators { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::Utc;
    use serde_json::Value as JsonValue;
...
pub mod roles { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use authenc_api::models::Role;
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod webauthn { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use authenc_api::models::WebauthnCredential;
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod identity_providers { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::{DateTime, Utc};
...
pub mod federated_identities { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::user::{CreateFederatedIdentityRequest, FederatedIdentity};
    use uuid::Uuid;
...
pub mod auth_flows { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::{AuthencError, Result};
    use chrono::Utc;
    use tracing::error;
...
pub mod resources { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::{AuthencError, Result};
    use authenc_api::models::resource::{CreateResourceRequest, Resource, UpdateResourceRequest};
    use chrono::Utc;
    use tracing::error;
    use uuid::Uuid;
...
use authenc_api::models::events::{AdminEvent, AuthDetails, Event, EventType, OperationType, ResourceType};

use authenc_core::spi::events::{AdminEventOperationType, AdminEventQuery, EventQuery};
...
pub mod tokens { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::Result;
    use chrono::{DateTime, Utc};
    use uuid::Uuid;
...
pub mod permission_tickets { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::{AuthencError, Result};
...
pub mod scopes { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::{AuthencError, Result};
    use authenc_api::models::scope::{CreateScopeRequest, Scope, UpdateScopeRequest};
    use chrono::Utc;
    use tracing::error;
    use uuid::Uuid;
...
pub mod resource_servers { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::Result;

    use authenc_api::models::resource_server::{             CreateResourceServerRequest, ResourceServer, UpdateResourceServerRequest,         };
    use uuid::Uuid;
    ...
    pub async fn update_resource_server(
        ...
        match db.query_opt(
            ...
            .await?
        {
            Some(row) => row.to_model(),
            None => Err(authenc_api::error::AuthencError::resource_not_found(format!(
...
pub mod user_consents { use crate::database::RowExt;
    use crate::database::Database;

    use authenc_api::error::{AuthencError, Result};

    use authenc_api::models::{ConsentGrantRequest, UserConsent};
...
pub mod sessions { use crate::database::RowExt;
    use super::*;
    use sha2::{Digest, Sha256};

    /// Store a session in the database
    pub async fn store_session(db: &Database, session: &authenc_api::models::session::Session) -> Result<()> {
        let query = r#"
...
pub mod themes { use crate::database::RowExt;
    use super::*;
    ...
    pub async fn set_realm_theme(
        ...
        let column_name = match theme_type {
            ...
            _ => return Err(authenc_api::error::AuthencError::validation("Invalid theme type")),
        };
...
pub mod policies { use crate::database::RowExt;
    use crate::database::Database;
    use authenc_api::error::{AuthencError, Result};
    use authenc_api::models::Policy;
    use chrono::Utc;
    use uuid::Uuid;
...
pub mod spi { use crate::database::RowExt;
    use crate::database::Database;
