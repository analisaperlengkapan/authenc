...
### Changed
- **[BREAKING] Security Authorization:** The  and  endpoints now strictly require an  header (). They were previously inadvertently unauthenticated. Integrations enumerating these endpoints anonymously will now receive a .
