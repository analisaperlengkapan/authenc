/// Tests for authorization policy evaluators
/// NOTE: These tests are COMPLETELY DISABLED as they reference
/// DefaultAuthorizationService which does not exist in the current codebase.
/// The authorization module uses AuthorizationManager instead.
/// TODO: Rewrite these tests to use AuthorizationManager with proper database setup
