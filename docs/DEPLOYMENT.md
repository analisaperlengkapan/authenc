# Authence Deployment Guide

This guide provides best practices for deploying Authence securely and reliably in production environments.
...
- Example: `export AUTHENCE_JWT_SECRET=your-secret-key`
...
Create `/etc/systemd/system/authence.service`:
```
[Unit]
Description=Authence IAM Server
After=network.target

[Service]
Type=simple
User=authence
WorkingDirectory=/opt/authence
ExecStart=/opt/authence/target/release/authence
Restart=on-failure
Environment=AUTHENCE_JWT_SECRET=your-secret-key
