# Zero Trust & Compliance Guide for Authenc by Cipherce

Authenc is designed to support zero trust security principles and compliance with international standards (e.g., ISO 27001, GDPR, SOC2). This guide outlines how to configure and operate Authenc in a zero trust and compliant manner.
...
- **Microsegmentation:**
  - Deploy Authenc in a segmented network (e.g., separate DMZ, internal, and DB networks).
