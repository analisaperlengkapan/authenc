...
pub struct DefaultClientStorageProvider {
    oidc_client_store: Arc<authenc_services::services::stores::oidc_client_store::OidcClientStore>,
}
...
pub struct DefaultRoleStorageProvider {
    role_store: Arc<authenc_services::services::stores::role_store::RoleStore>,
}

impl DefaultRoleStorageProvider {
    /// Create a new default role storage provider
    pub fn new(role_store: Arc<authenc_services::services::stores::role_store::RoleStore>) -> Self {
        Self { role_store }
    }
}
...
pub struct DefaultGroupStorageProvider {
    group_store: Arc<authenc_services::services::stores::group_store::GroupStore>,
}

impl DefaultGroupStorageProvider {
    /// Create a new default group storage provider
    pub fn new(group_store: Arc<authenc_services::services::stores::group_store::GroupStore>) -> Self {
        Self { group_store }
    }
}
